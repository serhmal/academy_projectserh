...
<body> 
<form action="/forms/form_league.php" method="post" name="form_league"> 
<fieldset> 
...
<label for="uefaranking">UEFA ranking</label><br/> 
<input value="0" type="int" name="uefaranking" size="11"><br/> 


<label for="presidents_id">President of the league</label><br/> 
<?php 
		include ("../db.php");
